...
public class DummyControllerTest {
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) { // json 데이터를 요청 => Java Object(MessageConvetter의 Jackson라이브러리가 변환해서 받아준다.)
...
//		});
		...
		// 막약에 자바 오브젝트를 리턴하게 되면 MessageConverter가 Jaxkson라이브러리를 호출해서
